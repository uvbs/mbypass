...
namespace Maplestory
{
	...
	// thanks to David for providing these for my lazy ass (latest EMS @ June 2)
	const unsigned int crcMain = 0xc9f4a4;	// 8a 11 80 c2 01
	const unsigned int crcMainRet = 0xc9f4a9;
	const unsigned int crcSecondary = 0x14f0b70;
	const unsigned int crcSecondaryRet = 0x14f0b75;
	const unsigned int crcTertiary = 0x13facbd;
	const unsigned int crcTertiaryRet = 0x13f76c6;
